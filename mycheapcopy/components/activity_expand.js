       ...
       <div className={styles.popupscroll}>
          ...
          <div className={styles.hardfacts}>
            ...
            <div className="d-flex flex-row align-items-center justify-content-center">
              ...
              />
              <p className="col">
                {selectedActivity._source.activityDate.start.iso.split("T")[0] +
                  " - " +
        ...
        :
        <div className={"m-auto d-flex flex-column align-items-center justify-content-center "+styles.successwrapper}>
           <img
                src="svg/done.svg"
              ...
              <br/>
              <br/>
          <h3 className={styles.success+" text-center"}>Sucessfully booked "{selectedActivity._source.name}"!</h3>
        </div>
        }
